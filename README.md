...
The plan is to provide fully documented code and give easier to follow test scenarios/scripts once the initial paper draft is completed (See the LatexDraft/Bio_Constrained_RNN.tex file for an overview of the learning mechanisms and dynmical control and stability problems they address)
